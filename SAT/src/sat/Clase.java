...
public class Clase {
    ...
    public int getAlumnosPosibles() {
        return alumnosPosibles;
    }

    public void setAlumnosPosibles(int alumnosPosibles) {
        this.alumnosPosibles = alumnosPosibles;
    }
    public void agregarAlumnoPosible(){
        alumnosPosibles++;
    }
